...
#+#:excluded (loop for i below 10 do (print (randval 10)))
...
#+#:excluded (make-monster)

(defmethod monster-hit ((m monster) x)
...
(pushnew 'make-orc *monster-builders*)
...
#+#:excluded (monster-show (make-orc))


(defstruct (hydra (:include monster)))
(pushnew 'make-hydra *monster-builders*)
...
#+#:excluded (monster-show (make-hydra))
...
#+#:excluded (monster-hit (make-hydra) 2)
...
(pushnew 'make-slime-mold *monster-builders*)

(defmethod monster-show ((m slime-mold))
  (princ "A slime mold with a sliminess of ")
  (princ (slime-mold-sliminess m)))

#+#:excluded (monster-show (make-slime-mold))
...
(pushnew 'make-brigand *monster-builders*)
